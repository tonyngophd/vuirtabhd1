...
import static com.suas.vuirtab1.MediaGalleryFragment.currentImageIndex;
import static com.suas.vuirtab1.MediaGalleryFragment.loadPercent;
import static com.suas.vuirtab1.MediaGalleryFragment.needToReloadImage0;
...
public class MediaFileAdapter extends RecyclerView.Adapter<MediaFileAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final MediaFileAdapter.ViewHolder viewHolder, int i) {
        ...
        //Log.i(TAG, "onBindViewHolder: thumblocation = " + galleryList.get(i).getThumb_location());
        if (file.exists()) {
            ...
            if (galleryList.get(i).getImage_Location().contains("jpg")) {
                ...
                if (imagefile.exists())
                    ...
                    || galleryList.get(i).getImage_Location().contains("mjpeg")
                    || galleryList.get(i).getImage_Location().contains("mov")) {
            ...
            if (bmp != null) {
                ...
                Log.i(TAG, "onBindViewHolder: mfolderpath = " + mfolderpath);
        ...
        //Log.i(TAG, "onBindViewHolder: percent loadPercent = " + loadPercent);
        //showPercent(i);
                ...
                public void onClick(View v) {
                    ...
                    if (galleryList.get(index).getImage_Location().contains("jpg")) {
                        if (imageView != null) {
                            ...
                            //Log.i(TAG, "onClick: index = " + index + " title = " + galleryList.get(index).getImage_title() + " location = " + galleryList.get(index).getImage_Location());
                            ...
                            || galleryList.get(index).getImage_Location().contains("mjpeg")
                            || galleryList.get(index).getImage_Location().contains("mov")) {
                        if (videoView != null) {
                            if (imageView != null) imageView.setVisibility(View.GONE);
    ...
    private String videoDuration(VideoView videoView) {
        //Log.i(TAG, "videoDuration: " + videoView.getDuration());
    ...
    private class DragListener implements GestureDetector.OnGestureListener {
        ...
        public void onLongPress(MotionEvent motionEvent) {
            Log.i(TAG, "onLongPress: inded = " + viewHolder.index);
        }
