...
import static com.suas.vuirtab1.MediaGalleryFragment.TAG;
import static com.suas.vuirtab1.MediaGalleryFragment.needToClick;
import static com.suas.vuirtab1.MediaGalleryFragment.needToReloadImage0;
import static com.suas.vuirtab1.MediaGalleryFragment.resetFolderIcons;
import static com.suas.vuirtab1.MediaGalleryFragment.window;
...
public class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final FolderAdapter.ViewHolder viewHolder, int i) {
        ...
        Log.i(TAG, "onBindViewHolder: title = " + galleryListFolder.get(i).getImage_title());
                    ...
                    if(!viewHolder.currentFolder || needToClick) {
                        ...
                        new Handler().post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Log.i(TAG, "onBindViewHolder: title = " + galleryListFolder.get(viewHolder.index).getImage_title());
                            }
                        });
                        ...
                        Log.d(TAG, "onClick: Current folder, do nothing");
                    }
                }
            });
        }
